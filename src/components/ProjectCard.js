      ...
      <div className="bg-background-paper rounded-lg shadow-md h-full flex flex-col relative transform transition-transform duration-300 hover:-translate-y-1 hover:shadow-aws">
        ...
        <div className="p-6 flex-grow">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-primary-dark text-white">
              {category}
            </span>
            {technologies.map((tech, index) => (
              <span
                key={index}
                className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-secondary border border-secondary hover:bg-secondary hover:text-white transition-colors duration-200"
              >
                {tech}
              </span>
            ))}
        ...
        <div className="px-6 pb-4">
          {githubLink && (
            <a
              ...
              className="inline-flex items-center mr-4 text-primary hover:text-primary-dark transition-colors duration-200"
            >
